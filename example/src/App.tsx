...
// // // // function App() {
// // // //   const [{ otp, numInputs, separator, minLength, maxLength, placeholder, inputType, inputColor }, setConfig] = React.useState({
// // // //       otp: '',
// // // //       numInputs: 4,
// // // //       separator: '-',
// // // //       minLength: 0,
...
// // // //       </div>
// // // //       <div className="view">
// // // //         <div className="card" style={{ backgroundColor: inputColor }}> {/* Change the background color of this container */}
...
// //       </div>
// //       <div className="view">
// //         <div className="card" style={{ backgroundColor: inputColor, width: '400px', height: 'auto', padding: '20px' }}>
// //           <form onSubmit={handleSubmit}>
...
//       </div>
//       <div className="view">
//         <div className="card" style={{ backgroundColor: inputColor, width: '400px', height: 'auto', padding: '20px', textAlign: 'center' }}>
//           <form onSubmit={handleSubmit}>
//             {/* Display the Logo if uploaded */}
//             {logoFile && (
//               <img
